...
\begin{document}
	...
	\section{Resultados}
	El código genera un gráfico en el que se la evolución temporal de la posición, la velocidad y el momentum. Genera tambien un .dat con 4 columnas: t, x, v, $\rho$
	...
	Ligado a esto se observa que la velocidad describe un comportamiento similar, dando cuenta del frenado rápido de la masa debido al agua del recipiente. De igual forma para el momentum.
